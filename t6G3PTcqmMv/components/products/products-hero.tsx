    ...
    <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-20 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <span className="text-primary text-sm font-medium tracking-wider uppercase">Our Products</span>
          <h1 className="mt-4 text-4xl md:text-5xl lg:text-6xl font-bold text-foreground font-display text-balance">
            Industrial Machinery for Processing, Classification, Bagging, and Handling
          </h1>
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed text-pretty">
            Explore TYCO&apos;s range of industrial equipment designed for practical performance across multiple industries.
          </p>
        </motion.div>
      </div>
    </section>
